...
import { MoreHorizontal, FileText, CheckCircle, XCircle, Eye, ArrowUpDown, ArrowUp, ArrowDown, Download, FileSpreadsheet, Printer, Loader2, User, Users } from "lucide-react";
...
export type UserType = "Seller" | "Influencer" | "Buyer" | "Merchant";
...
const kycRequestsData: KycRequest[] = [
  ...
  { id: "kyc006", userId: "usr106", name: "Anika Mehra", userType: "Seller", submissionDate: "2024-07-18T10:00:00Z", status: "Pending", documentType: "Aadhaar", documentImages: [{ name: "Aadhaar", url: "https://placehold.co/600x400.png", aiHint: "document identity" }], details: { "Aadhaar Number": "XXXX-XXXX-5678" } },
  { id: "kyc007", userId: "usr107", name: "Kabir Yadav", userType: "Influencer", submissionDate: "2024-07-18T11:00:00Z", status: "Approved", documentType: "PAN Card", documentImages: [{ name: "PAN", url: "https://placehold.co/600x400.png", aiHint: "document tax" }], details: { "PAN Number": "FGHIJ5678K" } },
  { id: "kyc008", userId: "usr108", name: "Diya Chopra", userType: "Buyer", submissionDate: "2024-07-17T12:00:00Z", status: "Rejected", documentType: "Passport", documentImages: [{ name: "Passport", url: "https://placehold.co/600x400.png", aiHint: "document passport" }], details: { "Passport Number": "AB1234567" }, rejectionReason: "Signature mismatch" },
  { id: "kyc009", userId: "usr109", name: "Ishaan Gupta", userType: "Seller", submissionDate: "2024-07-17T13:00:00Z", status: "Pending", documentType: "Voter ID", documentImages: [{ name: "Voter ID", url: "https://placehold.co/600x400.png", aiHint: "document voting" }], details: { "Voter ID Number": "LMN6789012" } },
  { id: "kyc010", userId: "usr110", name: "Myra Bhat", userType: "Merchant", submissionDate: "2024-07-16T14:00:00Z", status: "Approved", documentType: "Driving License", documentImages: [{ name: "License", url: "https://placehold.co/600x400.png", aiHint: "document license" }], details: { "License Number": "MH0220230012345" } },
  { id: "kyc011", userId: "usr111", name: "Arjun Reddy", userType: "Seller", submissionDate: "2024-07-16T15:00:00Z", status: "Pending", documentType: "Aadhaar", documentImages: [{ name: "Aadhaar", url: "https://placehold.co/600x400.png", aiHint: "document identity" }], details: { "Aadhaar Number": "XXXX-XXXX-1122" } },
  { id: "kyc012", userId: "usr112", name: "Kiara Agarwal", userType: "Influencer", submissionDate: "2024-07-15T16:00:00Z", status: "Approved", documentType: "PAN Card", documentImages: [{ name: "PAN", url: "https://placehold.co/600x400.png", aiHint: "document tax" }], details: { "PAN Number": "PQRST1122U" } },
  { id: "kyc013", userId: "usr113", name: "Vivaan Joshi", userType: "Buyer", submissionDate: "2024-07-15T17:00:00Z", status: "Rejected", documentType: "Passport", documentImages: [{ name: "Passport", url: "https://placehold.co/600x400.png", aiHint: "document passport" }], details: { "Passport Number": "CD3456789" }, rejectionReason: "Photo not clear" },
  { id: "kyc014", userId: "usr114", name: "Sara Khan", userType: "Seller", submissionDate: "2024-07-14T18:00:00Z", status: "Pending", documentType: "Voter ID", documentImages: [{ name: "Voter ID", url: "https://placehold.co/600x400.png", aiHint: "document voting" }], details: { "Voter ID Number": "VWX3456789" } },
  { id: "kyc015", userId: "usr115", name: "Reyansh Kumar", userType: "Merchant", submissionDate: "2024-07-14T19:00:00Z", status: "Approved", documentType: "Driving License", documentImages: [{ name: "License", url: "https://placehold.co/600x400.png", aiHint: "document license" }], details: { "License Number": "UP3220220054321" } },
  { id: "kyc016", userId: "usr116", name: "Aisha Verma", userType: "Seller", submissionDate: "2024-07-13T20:00:00Z", status: "Pending", documentType: "Aadhaar", documentImages: [{ name: "Aadhaar", url: "https://placehold.co/600x400.png", aiHint: "document identity" }], details: { "Aadhaar Number": "XXXX-XXXX-3344" } },
  { id: "kyc017", userId: "usr117", name: "Dev Singhania", userType: "Influencer", submissionDate: "2024-07-13T21:00:00Z", status: "Approved", documentType: "PAN Card", documentImages: [{ name: "PAN", url: "https://placehold.co/600x400.png", aiHint: "document tax" }], details: { "PAN Number": "YZABC3344D" } },
  { id: "kyc018", userId: "usr118", name: "Zara Ali", userType: "Buyer", submissionDate: "2024-07-12T22:00:00Z", status: "Rejected", documentType: "Passport", documentImages: [{ name: "Passport", url: "https://placehold.co/600x400.png", aiHint: "document passport" }], details: { "Passport Number": "EF5678901" }, rejectionReason: "Document expired" },
  { id: "kyc019", userId: "usr119", name: "Rudra Shah", userType: "Seller", submissionDate: "2024-07-12T23:00:00Z", status: "Pending", documentType: "Voter ID", documentImages: [{ name: "Voter ID", url: "https://placehold.co/600x400.png", aiHint: "document voting" }], details: { "Voter ID Number": "QRS6789012" } },
  { id: "kyc020", userId: "usr120", name: "Anya Iyer", userType: "Merchant", submissionDate: "2024-07-11T10:00:00Z", status: "Approved", documentType: "Driving License", documentImages: [{ name: "License", url: "https://placehold.co/600x400.png", aiHint: "document license" }], details: { "License Number": "TN0520210067890" } },
];

type KYCStatus = "Pending" | "Approved" | "Rejected";
type SortableKycKeys = keyof Pick<KycRequest, 'id' | 'name' | 'userType' | 'submissionDate' | 'documentType' | 'status'>;
...
export default function KycPage() {
  ...
  const processedKycRequests = useMemo(() => {
    ...
    if (searchTerm) {
      ...
      filteredItems = filteredItems.filter(req =>
        ...
        req.userType.toLowerCase().includes(lowerSearchTerm) ||
  ...
  const handleExportCSV = () => {
    const headers = ["Request ID", "User Name", "User Type", "Submission Date", "Document Type", "Status", "Details", "Rejection Reason"];
    const csvRows = [
      headers.join(','),
  ...
  const handleExportPDF = () => {
    const doc = new jsPDF();
    const tableColumn = ["ID", "Name", "User Type", "Date", "Doc Type", "Status", "Details", "Reason"];
    ...
    autoTable(doc, {
      ...
      columnStyles: { 6: { cellWidth: 'auto' }, 7: { cellWidth: 'auto' } }
    });
        ...
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto items-stretch sm:items-center">
                <Input
                  placeholder="Search ID, Name, User Type, Doc..."
                  value={searchTerm}
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead onClick={() => handleSort('userType')} className="cursor-pointer hover:bg-muted/50 group">
                  <div className="flex items-center gap-1">User Type {renderSortIcon('userType')}</div>
                </TableHead>
